                            ...
                            <div class="row clearfix">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="fname" class="form-control" value="{{$doctor->fname}}" placeholder="First Name" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <input type="text" name="lname" class="form-control" value="{{$doctor->lname}}" placeholder="Last Name" required>
                                    </div>
                                </div>
                            </div>
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <textarea rows="4" name="description" class="form-control no-resize"
                                            placeholder="Please type what you want...">{{$doctor->description}}</textarea>
                                    </div>
                                </div>
                                <div class="col-sm-12">

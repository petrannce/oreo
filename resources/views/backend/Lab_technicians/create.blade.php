        ...
        <div class="block-header">
            <div class="row">
                <div class="col-lg-7 col-md-5 col-sm-12">
                    <h2>Add Lab Technician
                        <small>Welcome to Hospital System</small>
                    </h2>
                </div>
                <div class="col-lg-5 col-md-7 col-sm-12">
                    <ul class="breadcrumb float-md-right">
                        <li class="breadcrumb-item"><a href="{{ route('dashboard.lab_technicians') }}"><i
        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Add</strong> Lab Technician </h2>
                        ...
                        <div class="body">
                            <form action="{{ route('lab_technicians.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="license_number" class="form-control"
                                                placeholder="e.g. LT12345" required>
                                        </div>
                                    </div>

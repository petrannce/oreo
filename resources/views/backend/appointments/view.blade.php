        ...
        <div class="container-fluid">
            <div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12">
                    <div class="card">
                        <div class="header">
                            <h2><strong>Appointment</strong> Information <small>Appointment details...</small> </h2>
                        ...
                        <div class="body">
                            ...
                            <div class="row clearfix">
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="time" class="form-control" value="{{ $appointment->time }}"
                                ...
                                <div class="col-sm-3">
                                    <div class="form-group">
                                        <input type="text" class="form-control" value="{{ $appointment->status }}"

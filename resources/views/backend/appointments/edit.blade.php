                                    ...
                                    <div class="col-sm-4">
                                        <div class="input-group">
                                            ...
                                            <input name="date" type="date" class="form-control datetimepicker"
                                                min="{{date('Y-m-d')}}" value="{{ $appointment->date }}">
                                        </div>
                                    </div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-sm-4">
                                        <select name="service_id" class="form-control show-tick">
                                            <option value="" disabled {{ $appointment->service_id ? '' : 'selected' }}>- Select Service -</option>
                                    ...
                                    <div class="col-sm-4">
                                        <select name="doctor_id" class="form-control show-tick">
                                            <option value="" disabled {{ $appointment->doctor_id ? '' : 'selected' }}>- Select Doctor -</option>

                                    ...
                                    <tbody>
                                        @foreach($appointments as $appointment)
                                                                        @php
                                                                            ...
                                                                            // Determine if Move Stage button should be disabled
                                                ...
                                                default => 'light'
                                                                            ...
                                                                            <td>
                                                                                @if(!$isFinalStage)
                                                                                    <div class="dropdown">
                                                                                        ...
                                                                                        <div class="dropdown-menu">
                                                                                            @foreach(['reception', 'triage', 'doctor_consult', 'lab', 'pharmacy', 'billing', 'completed'] as $nextStage)
                                                                            ...
                                                                            <td>
                                                                                ...
                                                                                {{-- LAB TECHNICIAN --}}
                                                                                @if($stage === 'lab' && auth()->user()->hasAnyRole(['lab_technician', 'admin']))
                                                                                    @if($appointment->labTest)
                                                                                        <a href="{{ route('lab_tests.show', $appointment->labTest->id) }}"
                                                                                            class="btn btn-sm btn-success">
                                                                                ...
                                                                                @if($stage === 'pharmacy' && auth()->user()->hasAnyRole(['pharmacist', 'admin']))
                                                                                    @if($appointment->pharmacyOrder)
                                                                                        <a href="{{ route('pharmacy_orders.show', $appointment->pharmacyOrder->id) }}"
                                                                                            class="btn btn-sm btn-success">
                                                                                ...
                                                                                {{-- BILLING --}}
                                                                                @if($stage === 'billing' && auth()->user()->hasAnyRole(['admin', 'pharmacist']))

            ...
            <div class="body">
                ...
                <table class="table table-bordered">
                    ...
                    <tbody>
                        @foreach($billing->items as $item)
                            <tr>
                                <td><input type="text" value="{{ $item->description }}" class="form-control bg-light" readonly></td>
                                <td><input type="number" value="{{ $item->quantity }}" class="form-control bg-light" readonly></td>
                                <td><input type="text" value="{{ number_format($item->unit_price, 2) }}" class="form-control bg-light" readonly></td>
                                <td><input type="text" value="{{ number_format($item->subtotal, 2) }}" class="form-control bg-light" readonly></td>
                            </tr>
                        @endforeach
                    </tbody>
                    <tfoot>
                ...
                <form action="{{ route('billings.update', $billing->id) }}" method="POST">
                    ...
                    <div class="text-center mt-4 d-flex flex-wrap justify-content-center gap-2">
                        ...
                        <a href="{{ route('billings.receipt', $billing->id) }}" target="_blank" class="btn btn-info btn-round">
